...
LoadPosition::LoadPosition(double setpoint): Command() {
    m_setpoint = setpoint;
...
void LoadPosition::Execute() {
}

// Make this return true when this Command no longer needs to run execute()
bool LoadPosition::IsFinished() {
...
void LoadPosition::End() {

}

// Called when another command which requires one or more of the same
// subsystems is scheduled to run
void LoadPosition::Interrupted() {
